...
export const Footer: FC = (): ReactElement => {
    return (
      <Box 
        className="w-full h-auto bg-blue-600 bg-opacity-95 p-1 border-3 border-gray-700 text-gray-300 text-xl"
        
      >
        <Container className="border-3 border-gray-700 max-w-lg" >
          <Grid className ="container columns-1  text-center content-evenly ">
            <Grid className="text-xl">
            <Typography className="footer" >
              Counting CO<sub>2</sub> Emissions 
            </Typography>
          </Grid>
